...
import { resolveAndFetchImages } from './images.js'
import { convertBlocks, NUMBERING_CONFIG, ORDERED_LIST_CONFIG_INDEX } from './nodes.js'
import { DOCX_STYLES } from './styles.js'
import type { MdNode, DocxExportOptions, DocxContext } from './types.js'
import { assertPmTreeBounds } from '../policy.js'
...
export async function serializeDocx(
  ...
  // Reject adversarially deep trees before any recursive image or block walk.
